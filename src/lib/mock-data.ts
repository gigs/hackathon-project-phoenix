...
export const MOCK_PORTFOLIO: PortfolioEntry[] = [
  {
    ...
    driName: "Daniel Grant Smith",
    whyNow: "US expansion is moving, but UK execution and pricing threads still need close watching.",
    openRiskCount: 3,
    nextMilestone: "US Go-Live Target",
    nextMilestoneDate: "2026-06-24",
    lastUpdated: "2026-04-17T14:00:00Z",
  },
  {
    slug: "revolut",
    ...
    driName: "Felipe I.",
    whyNow: "Webhook latency and launch-readiness issues are concentrated in the UK rollout.",
    openRiskCount: 2,
    nextMilestone: "UK Beta Launch",
    nextMilestoneDate: "2026-05-01",
    lastUpdated: "2026-04-17T14:00:00Z",
  },
  {
    slug: "santander",
    ...
    topLineHealth: [],
    driName: null,
    whyNow: "Low-signal account, needs more connected data before it becomes decision-ready.",
    openRiskCount: 0,
    nextMilestone: null,
